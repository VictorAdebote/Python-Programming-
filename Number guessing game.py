...
# Compare the users input to computers choice.
# If users input is the same with computers choice the user has won.
# If users input is less than computers choice print too low.
# Else print too high.
